...
## 1. SLAYER Flight Computer [SLAYER Files](../blob/main/SLAYER_FlightComputer)
### Overview
...
### Criteria
[I'm a relative reference to a repository file](../blob/main/SLAYER_FlightComputer/NonTechnical/SLAYER_ProjectProposal.pdf)
